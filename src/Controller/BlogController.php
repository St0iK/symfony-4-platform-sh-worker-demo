...
class BlogController extends AbstractController
{
     ...
     */
    public function index(int $page, string $_format, PostRepository $posts, Producer $producer ): Response
    {
    ...
    /**
     * @Route("/add", defaults={"page": "1", "_format"="html"}, name="blog_add")
     * @Method("GET")
     * @Cache(smaxage="10")
     *
     * NOTE: For standard formats, Symfony will also automatically choose the best
     ...
     * See https://symfony.com/doc/current/quick_tour/the_controller.html#using-formats
     */
    public function add(Producer $producer ): Response
    {
        $producer->sendEvent('aTopic', ['message' => 'So long and thanks for all the fish']);
